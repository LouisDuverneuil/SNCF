...
$('#exampleModalCenter').on('show.bs.modal', function (event) {
    ...
    trajet_gare_arrivee = trajet[2], trajet_prix = trajet[3];; // Extract info from data-* attributes
...
document.querySelector("#create-reservation").addEventListener('click', event => {
